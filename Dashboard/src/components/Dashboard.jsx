    ...
    const fetchAppointments = async () => {
      try {
        const { data } = await axios.get(
          "https://mern-stack-hospital-management-system-m1pi.onrender.com/api/v1/appointment/getall",
  ...
  const handleUpdateStatus = async (appointmentId, status) => {
    try {
      const { data } = await axios.put(
        `https://mern-stack-hospital-management-system-m1pi.onrender.com/api/v1/appointment/update/${appointmentId}`,
        { status },
        { withCredentials: true }
      );
